            ...
            {users.map(u => (
                <div key={u.id} className="vibrant-card rounded-[2.5rem] p-8 flex items-center space-x-6 group relative overflow-hidden">
                  ...
                  <button 
                      ...
                      className="opacity-0 group-hover:opacity-100 p-4 bg-red-600/10 text-red-500 rounded-2xl hover:bg-red-600 hover:text-white transition-all transform translate-x-4 group-hover:translate-x-0"
